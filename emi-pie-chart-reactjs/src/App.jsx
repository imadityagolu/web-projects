  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="gap-6">
          {/* Summary Card */}
          <div className="bg-white rounded-lg shadow-md p-6 text-center place-content-center relative">
            ...
            <div className="bg-white rounded-lg place-content-center text-center flex w-100">
